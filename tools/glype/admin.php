...
// Define a path to us
define('ADMIN_URI', pathToURL(__FILE__));
         ...
         foreach ( $options->section as $section ) {
            ...
            foreach ( $section->option as $option ) {
               ...
               if ( $section['type'] == 'user' ) {
                  ...
                  $force   = filter( ( isset($value['force'])   ? $value['force']   : $option['force']  ), 'bool');
